...
void Program_Init(void) {
	...
	Buttons_SetCallbacks(&button0, NULL, NULL, Modes_Main_SetNext, Modes_Main_ToggleEditActive);
	Buttons_SetCallbacks(&button1, NULL, NULL, Modes_Timing_SetNext, Modes_Timing_ToggleEditActive);
